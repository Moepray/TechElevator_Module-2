...
*/
INSERT INTO site (site_number, campground_id) VALUES (623,8), (624,8), (625,8)
RETURNING site_id;
...
VALUES (623, 'Wayne Family', '2022-5-15','2022-5-25'),(624,'Parker Family','2022-5-16','2022-5-25'),(625,'Kent Family','2022-5-17','2022-5-25')
 ...
 */
 UPDATE reservation SET from_date = '2022-5-5', to_date = '2022-5-12' WHERE reservation.name = 'Wayne Family';

/*
 STEP SEVEN: The Kent family called and they would like to cancel their reservation. Delete the reservation for Kent Family.

*/
DELETE FROM reservation WHERE reservation.name = 'Kent Family';
